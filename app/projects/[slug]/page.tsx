...
export default async function ProjectDetailPage({ params }: Props) {
  ...
  return <>
    ...
    <footer className="site-footer projects-footer"><img src="/assets/alifway_media_dark_purple_monogram_transparent.png" alt="" /><p>Alifway Media © 2026</p><Link className="footer-media-link" href="/projects">Projects <span className="media-nav-symbol" aria-hidden="true"><MediaIcon name="film" /></span></Link></footer>
  </>;
}
